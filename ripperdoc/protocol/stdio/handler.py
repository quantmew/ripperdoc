...
class StdioProtocolHandler(
    ...
    def __init__(
        ...
        self._can_use_tool: Optional[Any] = None
        self._local_can_use_tool: Optional[Any] = None
        ...
        self._sdk_hook_scope: Optional[HooksConfig] = None
        ...
        self._disallowed_tools: Optional[List[str]] = None
        self._sdk_transport: Optional[_SDKWebSocketTransport] = None
        self._tools_list: Optional[List[str]] = None
        self._tools_preset: Optional[str] = None
        self._session_additional_working_dirs: set[str] = set()
        self._fallback_model: Optional[str] = None
        self._max_budget_usd: Optional[float] = None
        self._json_schema: Optional[Dict[str, Any]] = None
        self._session_agent_name: Optional[str] = None
        self._session_agents: dict[str, dict[str, str]] = {}
        self._session_agent_prompt: Optional[str] = None
        ...
        self._mcp_server_overrides: Optional[Dict[str, McpServerInfo]] = None
        ...
        self._task_notification_task: Optional[asyncio.Task[None]] = None
        self._resolved_tool_use_ids: set[str] = set()
        self._idle_exit_delay_ms: Optional[int] = None
        self._idle_exit_task: Optional[asyncio.Task[None]] = None
        self._runtime_task: Optional[asyncio.Task[Any]] = None
