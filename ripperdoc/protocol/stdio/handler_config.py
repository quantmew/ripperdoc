...
from ripperdoc.core.system_prompt_builder import compose_system_prompt, select_base_system_prompt
from ripperdoc.protocol.model_types.stream import UserMessageData, UserStreamMessage
