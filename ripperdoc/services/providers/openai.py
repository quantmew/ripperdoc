...
from ripperdoc.services.thinking_config import default_thinking_effort
from ripperdoc.services.oauth.gitlab import (
    GitLabOAuthError,
    refresh_gitlab_access_token,
    resolve_gitlab_oauth_client_id,
)
from ripperdoc.services.providers.base import ProgressCallback, ProviderClient, ProviderResponse
